cpack_add_component(_cura
            DISPLAY_NAME "Dazzle DFStarter ${CURA_BUILDTYPE}"
            Description "Dazzle DFStarter ${CURA_BUILDTYPE} Executable and Data Files"
            REQUIRED
)
...
set(CPACK_PACKAGE_NAME "Dazzle DFStarter")
if(CURA_BUILDTYPE MATCHES "Enterprise")
    set(CPACK_PACKAGE_NAME "Dazzle DFStarter ${CURA_BUILDTYPE}")
endif()
string(REPLACE " " "_" CPACK_FILE_NAME_NO_SPACES "${CPACK_PACKAGE_NAME}")

set(CPACK_PACKAGE_VENDOR "Dazzle")
...
set(CPACK_PACKAGE_NAME "Dazzle DFStarter ${CURA_BUILDTYPE} ${CURA_FULL_VERSION}")

set(CPACK_PACKAGE_ICON "${CMAKE_SOURCE_DIR}/packaging/cura.ico")
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Dazzle DFStarter - 3D Printing Software")
...
set(CPACK_CREATE_DESKTOP_LINKS DFStarter "Dazzle DFStarter ${CURA_FULL_VERSION}")
set(CPACK_PACKAGE_EXECUTABLES DFStarter "Dazzle DFStarter ${CURA_FULL_VERSION}")
set(CPACK_PACKAGE_INSTALL_DIRECTORY "Dazzle DFStarter ${CURA_FULL_VERSION}")
if(CURA_BUILDTYPE MATCHES "Enterprise")
    set(CPACK_CREATE_DESKTOP_LINKS DFStarter "Dazzle DFStarter ${CURA_BUILDTYPE} ${CURA_FULL_VERSION}")
    set(CPACK_PACKAGE_EXECUTABLES DFStarter "Dazzle DFStarter ${CURA_BUILDTYPE} ${CURA_FULL_VERSION}")
    set(CPACK_PACKAGE_INSTALL_DIRECTORY "Dazzle DFStarter ${CURA_BUILDTYPE} ${CURA_FULL_VERSION}")
endif()
